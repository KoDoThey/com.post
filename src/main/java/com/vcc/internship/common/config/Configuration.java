...
public class Configuration extends Properties {
    ...
    // Below properties variable only use for a session when properties from defaultResPath not null or it was specified
    private static final Properties currentProps = new Properties();
    ...
    static {
        try {
            ...
            if (defaultResPath != null) {
                currentProps.load(new InputStreamReader(new FileInputStream(defaultResPath)));
            }
        } catch (IOException e) {
    ...
    public Configuration() {
        // Do not load the default file config from this initialize
    }
    ...
    public void addResource(String path) throws IOException {
        if (path != null) {
            currentProps.load(new InputStreamReader(new FileInputStream(path)));
        }
    }

    @Override
    public String getProperty(String key) {
        String value = currentProps.getProperty(key);
    ...
    public synchronized String toString() {
        ...
        keySet.addAll(currentProps.keySet());
