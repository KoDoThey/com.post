...
public class MyResponseStatus {
    ...
    public static Response toServerErrorResponse(String message, JSONObject entity) {
        JSONObject res = new JSONObject();
        res.put("status", ERROR_STATUS)
                .put("message", message)
                .put("code", Response.Status.INTERNAL_SERVER_ERROR.getStatusCode())
    ...
    public static Response toUserPermissionDeneid() {
        JSONObject res = new JSONObject();
        res.put("status", ERROR_STATUS)
                .put("message", "User Permission Denied")
                .put("code", Response.Status.UNAUTHORIZED.getStatusCode())
                .put("result", new JSONArray());
